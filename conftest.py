...
#
# # 환경변수 기반 설정
# TESTRAIL_BASE_URL = os.getenv("TESTRAIL_BASE_URL", "https://your-domain.testrail.io")
# TESTRAIL_PROJECT_ID = int(os.getenv("TESTRAIL_PROJECT_ID", "1"))
# TESTRAIL_SUITE_ID = int(os.getenv("TESTRAIL_SUITE_ID", "1"))
# TESTRAIL_SECTION_NAME = os.getenv("TESTRAIL_SECTION_NAME", "고급 검색")  # ✅ 섹션 이름으로 지정
# TESTRAIL_USER = os.getenv("TESTRAIL_USER", "your.email@example.com")
# TESTRAIL_TOKEN = os.getenv("TESTRAIL_TOKEN", "your_api_token")
#
